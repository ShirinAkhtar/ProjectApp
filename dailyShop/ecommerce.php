  ...
  <section id="aa-product-category">
    <div class="container">
     ...
     while ($row = $result->fetch_assoc()) {
      if($row["tag"] == "E-Commerce,Shop," || $row["tag"] == "E-Commerce,Shop,Headphone," || $row["tag"] == "E-Commerce,Shop,Laptop," || $row["tag"] == "Fashion,E-Commerce,Shop," ) {
      ?>
                ...
                <li>
                  ...
                  <form method="post" action="ecommerce.php?action=<?php echo $row["id"]; ?>" >
