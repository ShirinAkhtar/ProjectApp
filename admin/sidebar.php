		...
		<div id="sidebar">
            ...
            <?php 
                ...
                $productmenu1 = array('user.php');
                $productmenu2 = array('order.php');
                $productmenu3 = array('dashboard.php');
            ?>
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					<a href="dashboard.php" class="nav-top-item <?php if (in_array($filename, $productmenu3) ) : ?>current<?php endif;?>"> <!-- Add the class "no-submenu" to menu items with no sub menu -->
						Dashboard
					</a>       
				</li>
				...
				<li>
					...
					<ul>
						<li><a <?php if ($filename == 'user.php') : ?> class="current" <?php endif;?> href="user.php">Manage Users</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li><a <?php if ($filename == 'order.php') : ?> class="current" <?php endif;?> href="order.php">Manage Order</a></li>
					</ul>
				</li>
